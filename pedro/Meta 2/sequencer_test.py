...
def local_file_path(file_name: str) -> str:
    ...
    return join(abspath(join(dirname(__file__), "..")), file_name)
...
if __name__=="__main__":
    ...
    sfid = fs.sfload(local_file_path("/Users/pedronogueira/PUC/micro/Trabalho/GeneralUser-GS/GeneralUser-GS.sf2"))
